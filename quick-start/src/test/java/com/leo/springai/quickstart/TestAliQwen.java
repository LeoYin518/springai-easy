 ...
 */
@SpringBootTest
public class TestAliQwen {
    /**
     * 非流式调用
     */
    @Test
    public void testDashScope(@Autowired DashScopeChatModel chatModel) {
     ...
     */
    @Test
    public void testDashScopeStream(@Autowired DashScopeChatModel chatModel) {
     ...
     */
    @Test
    public void testDashScopeOptions(@Autowired DashScopeChatModel chatModel) {
    ...
    @Test
    public void testDashScopeOptionsStream(@Autowired DashScopeChatModel chatModel) {
